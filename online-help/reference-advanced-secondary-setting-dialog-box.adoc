...
http://www.netapp.com/us/media/tr-3966.pdf["Rapport technique de NetApp 3966 : Guide de déploiement et d'implémentation de la compression des données et de la déduplication NetApp (clustered Data ONTAP)"]
